...
const Message: React.FC<MessageProps> = ({ content, isUser }) => (
	<div
		className={`justify-center px-4 py-${
			isUser ? "3.5 text-white bg-teal-700" : "2.5 bg-zinc-100"
...
export const AIChat = ({ isHidden }: Props) => {
	...
	return isHidden ? (
		...
		<div className="flex flex-col max-w-[529px] ">
			<Form {...form}>
				<form
					onSubmit={form.handleSubmit(onSubmit)}
					className="flex flex-col py-7 w-full bg-white rounded-xl shadow-sm max-md:max-w-full"
				>
					<header className="flex gap-5 justify-between px-6 py-px w-full text-lg font-semibold text-black whitespace-nowrap max-md:flex-wrap max-md:px-5 max-md:max-w-full">
						<div className="flex gap-2.5 justify-between">
							<img
								loading="lazy"
								src="https://cdn.builder.io/api/v1/image/assets/TEMP/495478d9e5b29d624800b80a564cffbfd1437cc245d80e170520eeb924992148?apiKey=ffbac9baaace46a9ab45d6e0b9f2c125&"
								alt="LoreAI logo"
						...
						<img
							loading="lazy"
							src="https://cdn.builder.io/api/v1/image/assets/TEMP/e7647d05ed21e53dfd9c3f429410cf8635ab0dc31a1d01757913ea4007e86bfc?apiKey=ffbac9baaace46a9ab45d6e0b9f2c125&"
							alt="Options icon"
							className="shrink-0 my-auto w-6 aspect-[4.76]"
						/>
					</header>
					<section className="flex flex-col items-end px-5 mt-10 w-full text-base font-medium leading-5 text-zinc-700 text-opacity-80 max-md:max-w-full">
